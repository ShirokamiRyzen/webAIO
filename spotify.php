...
<head>
  ...
  <title>Download - Spotify Mod</title>
    ...
    <section class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Downloads</h2>
          <p>You can download Spotify Mod from link below, no need to compile. Just Install and Enjoy!!</p>
        </div>
        ...
        <div class="row" data-aos="fade-right">
          <div class="col-md-4 mb-3">
            <div class="card">
              <div class="card-body">
                <center>
                  <span style="color: #ff3c3c; font-size: 18pt;"><b>Spotify Mod (64 bit)</b>
                  </span>
                  <br>
                  <span>com.spotify.music</span>
                  <p style="text-align: center;"><b>• Replace Stock app</b><br>
                  <table class="" style="width: 100%;">
                    <tbody>
                      <tr>
                        <td>Version :</td>
                        <td>8.7.78.373 (latest)</td>
                      </tr>
                      <tr>
                        <td>Link Status:</td>
                        <td> Alive</td>
                  ...
                  <p class="card-text"></p>
                  <a href="https://gg.gg/12r050" class="btn gdrive">DOWNLOAD (DIRECT)
                  ...
                  <p class="card-text"></p>
                  <a href="https://gg.gg/12r13d" class="btn gdrive">DOWNLOAD (MIRROR)
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                      class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
                      <path fill-rule="evenodd"
                        d="M7.646 10.854a.5.5 0 0 0 .708 0l2-2a.5.5 0 0 0-.708-.708L8.5 9.293V5.5a.5.5 0 0 0-1 0v3.793L6.354 8.146a.5.5 0 1 0-.708.708l2 2z" />
          ...
          <div class="col-md-4 mb-3">
            <div class="card">
              <div class="card-body">
                <center>
                  <span style="color: #ff3c3c; font-size: 18pt;"><b>Spotify Mod (32 bit)</b>
                  </span>
                  <br>
                  <span>com.spotify.music</span>
                  <p style="text-align: center;"><b>• Replace Stock app</b><br>
                  ...
                  <p class="card-text"></p>
                  <a href="https://gg.gg/12r055" class="btn gdrive">DOWNLOAD (DIRECT)
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                      class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
                      <path fill-rule="evenodd"
                        d="M7.646 10.854a.5.5 0 0 0 .708 0l2-2a.5.5 0 0 0-.708-.708L8.5 9.293V5.5a.5.5 0 0 0-1 0v3.793L6.354 8.146a.5.5 0 1 0-.708.708l2 2z" />
                  ...
                  <p class="card-text"></p>
                  <a href="https://gg.gg/12r12y" class="btn gdrive">DOWNLOAD (MIRROR)
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                      class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
                      <path fill-rule="evenodd"
                        d="M7.646 10.854a.5.5 0 0 0 .708 0l2-2a.5.5 0 0 0-.708-.708L8.5 9.293V5.5a.5.5 0 0 0-1 0v3.793L6.354 8.146a.5.5 0 1 0-.708.708l2 2z" />
